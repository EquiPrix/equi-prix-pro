      ...
      >
        ...
        <form onSubmit={handleAuthAction} className="w-full flex flex-col gap-4 text-left">
          <div className="flex flex-col gap-1.5">
            <label className="text-2xs uppercase tracking-wider font-cinzel font-semibold" style={{ color: 'var(--gold-lt)' }}>Email Address</label>
          ...
          {!isSignUpMode && (
            <div className="flex flex-col gap-1.5">
              <label className="text-2xs uppercase tracking-wider font-cinzel font-semibold" style={{ color: 'var(--gold-lt)' }}>Password</label>
          ...
          <button type="submit" disabled={loading}
            ...
            style={{ backgroundColor: loading ? 'rgba(180,149,48,0.1)' : 'var(--gold)', color: loading ? 'var(--mid)' : '#0f0e0a' }}>
        ...
        <div className="mt-6 text-2xs uppercase tracking-wider font-cinzel text-gray-500 flex flex-col gap-1">
          ...
          <div>
            <span onClick={() => { setIsSignUpMode(!isSignUpMode); setMessage({ type: '', text: '' }); setEmail(''); setPassword(''); }}
              className="cursor-pointer font-bold hover:underline transition-all" style={{ color: 'var(--gold-lt)' }}>
